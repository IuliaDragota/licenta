            ...
            appBar: AppBar(
              ...
              title: const Text(
                ...
                bottom: PreferredSize(
                    ...
                    child: goalsProvider.isLoading ? const LinearProgressIndicator(color: Colors.deepPurpleAccent, backgroundColor: Color(0xFFB494DB)) : const SizedBox()
                )
            ),
            body: Stack(
              children: [
                    ...
                    Container(
                      ...
                      child: ElevatedButton(
                        ...
                        style: ElevatedButton.styleFrom(
                          primary: const Color(0xFFB9A9BD),
